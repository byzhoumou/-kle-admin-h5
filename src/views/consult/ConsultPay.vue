...
import { ConsultOrderPreData } from '@/types/consult'
...
const loadPatient = async () => {
  patient.value = { name: '未知', genderValue: '未知', age: '未知' } as any
...
<template>
  <div class="consult-pay-page" v-if="payInfo && patient">
    ...
    <van-cell-group>
      ...
      <van-cell title="实付款" :value="`-¥${payInfo.actualPayment}`" />
    </van-cell-group>
  ...
  <div class="cousnlt-pay-page" v-else>
    <cp-nav-bar tiltle="支付" />
    <!-- 骨架组件 -->
